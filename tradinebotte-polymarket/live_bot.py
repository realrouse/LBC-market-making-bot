...
# compute_stake / check_signal / enter_live_trade / check_resolution / close_trade /
# ThresholdStrategy live in pm_strategy (re-exported at the top of this module).
...
# save_cex_snapshot + cex_feed_consumer_loop live in cex_consumer.py (the CEX package);
# main() lazy-imports the loop only when data_source=cex_feed (Plan D step 4b).
