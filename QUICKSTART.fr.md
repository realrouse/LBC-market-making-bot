...
```bash
# Télécharger la dernière release (remplacer v0.48 par la version actuelle)
wget https://github.com/neofutur/tradinebotte/archive/refs/tags/v0.48.tar.gz
tar -xzf v0.48.tar.gz
cd tradinebotte-0.48
