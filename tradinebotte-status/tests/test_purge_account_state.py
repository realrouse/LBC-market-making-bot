...
class TestPurge(unittest.TestCase):
    ...
    def test_purges_test_account(self):
        ...
        hb, dep = p.purge_account(db, "acctT")
        db.close()
        self.assertEqual((hb, dep), (3, 1))
        self.assertEqual(self._counts("acctT"), (0, 0))
        self.assertEqual(self._counts("acctP"), (3, 1))  # prod untouched
    ...
    def test_inventory_guard_refuses_prod_account_via_main(self):
        ...
        self.assertEqual(self._counts("acctP"), (3, 1))  # nothing deleted
